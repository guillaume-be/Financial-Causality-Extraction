...
from transformers import DataProcessor, SquadExample, SquadFeatures
from transformers.tokenization_bert import whitespace_tokenize

logger = logging.getLogger(__name__)


def load_and_cache_examples(input_dir: str, model_name_or_path: str, tokenizer,
    ...
    if os.path.exists(cached_features_file) and not overwrite_cache:
        ...
        if evaluate:
            examples = processor.get_dev_examples(input_dir, filename=None)
        else:
            examples = processor.get_train_examples(input_dir, filename=None)
