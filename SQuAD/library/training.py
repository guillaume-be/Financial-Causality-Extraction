...
def train(train_dataset, model, tokenizer, train_batch_size: int,
          model_type: str, model_name_or_path: str, input_dir: str, output_dir: str, device: torch.device,
          ...
          max_seq_length: int, doc_stride: int, max_query_length: int, eval_batch_size: int,
